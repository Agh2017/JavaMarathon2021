...
public class Task2 {
    public static void main(String[] args) {
        ChessPiece[][] currentChessBoard = {
                ...
                {ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.BISHOP_WHITE, ChessPiece.PAWN_BLACK, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY},
        ...
        ChessBoard chessBoard = new ChessBoard(currentChessBoard);
        chessBoard.print();
    }
}
